...
import { CERTIFICATIONS_GUIDANCE, EXPERIENCE_PROJECT_GUIDANCE } from "./resume-extras";
import {
  ATS_PARSING_CHATGPT,
  BULLET_QUALITY,
...
<div class="job-project"><b>Project:</b> {{ROLE_${idx + 1}_PROJECT_NAME}} — {{ROLE_${idx + 1}_PROJECT_SUMMARY}}</div>
<ul>
...
<div class="certification-item">{{CERTIFICATION_1}}</div>
<div class="certification-item">{{CERTIFICATION_2}}</div>
<div class="certification-item">{{CERTIFICATION_3}}</div>
<div class="certification-item">{{CERTIFICATION_4}}</div>
<div class="certification-item">{{CERTIFICATION_5}}</div>
</div>
</div>
<div class="section">
